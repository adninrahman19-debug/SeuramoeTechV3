...
const NewWarrantyClaim: React.FC<NewWarrantyClaimProps> = ({ registration, onSuccess, onCancel }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      // In a real app, we'd create a claim linked to this registration
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
           ...
           <div className="p-4 bg-rose-600/5 border border-rose-500/20 rounded-2xl flex items-start gap-3">
              ...
              <p className="text-[10px] text-slate-400 leading-relaxed">
                 Klaim garansi hanya berlaku untuk cacat produksi. Kerusakan akibat kelalaian pengguna (terbentur, terkena air, segel rusak) dapat membatalkan garansi.
              </p>
           </div>
